...
@section('header')
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('messages.create') }}"><i class="glyphicon glyphicon-plus"></i> Create</a>
        </h1>
            ...
            @if($messages->count())
                <table class="table table-condensed table-striped">
                    <thead>
                        ...
                        <th>رقم الهاتف</th>
                        <th>الرساله</th>
                            <th class="text-right">الافعال</th>
                        </tr>
                    </thead>
